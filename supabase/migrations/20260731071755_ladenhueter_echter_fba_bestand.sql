...
returns table(
  asin text, lifetime_units bigint, lifetime_umsatz_cents bigint,
  units_0_30 bigint, umsatz_0_30_cents bigint,
  units_30_120 bigint, umsatz_30_120_cents bigint,
  erster_verkauf date, letzter_verkauf date, tage_ohne_verkauf integer,
  max_luecke_tage integer, neue_sku boolean,
  preis_alt_cents integer, preis_neu_cents integer,
  hat_angebot boolean, angebot_status text, bestand integer, ist_fba boolean,
